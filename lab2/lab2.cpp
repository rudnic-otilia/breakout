...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            1, 3, 7,    // indices for first triangle
            1, 5, 7,    // indices for second triangle
        };
        ...
        meshes["patrat"] = new Mesh("patrat");
        meshes["patrat"]->InitFromData(vertices_patrat, indices_patrat);

        // Actually create the mesh from the data
        CreateMesh("cube_B", vertices, indices);

        CreateMesh("tetraedru", vertices_tetra, indices_tetra);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(-1.8f, 1.5f, 1), glm::vec3(0.15f));

    // TODO(student): Draw the tetrahedron

    // TODO(student): Draw the square
    RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(-2.8f, 2.5f, 1), glm::vec3(0.15f));
